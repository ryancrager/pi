(function () {
  ...
  function updateChesterAge() {
    ...
    document.getElementById("chesterAge").textContent =
      `${ageParts.years} Years, ${ageParts.months} Months, ${ageParts.days} Days`;

    document.getElementById("chesterHumanAge").textContent =
      `${humanYears.toFixed(1)} Human Years`;
  }
